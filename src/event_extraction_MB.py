...
threshold = 10# seconds, choose a suitable value based on your data
...
for packet in cap:
    try:
        ...
        if inter_packet_delay <= threshold:
            ...
            burst_lengths.append(current_burst_length / (1024 * 1024))  # Convert to MB
